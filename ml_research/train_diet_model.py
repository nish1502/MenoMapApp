...
SYMPTOM_GOALS = {
    ...
    'hair_growth_on_facebody_ternary': {'trigger_avoid': ['dairy']},
...
if __name__ == '__main__':
    ...
    base_features = {
        ...
        'brain_fog_severity_ternary': 0, 'hair_growth_on_facebody_ternary': 0, 'mood_swings_irritability_severity_ternary': 0,
